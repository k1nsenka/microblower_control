...
void param_setting(MenuItem* sender) {
    switch(sender -> tag){
        default: return;
        case 101:
            Serial.println("############################");
            Serial.println("case MODE");
            break;
        case 102:
            Serial.println("############################");
            Serial.println("case INTIME");
            break;
        case 103:
            Serial.println("############################");
            Serial.println("case TARGET");
            break;
    }
...
void test_task0(void *arg){
    ...
    treeView.setItems(vmi
                    { new MenuItem("SETTING", param_setting, vmi
                    { new MenuItem("MODE", 101)
                    , new MenuItem("INTIME", 102)
                    , new MenuItem("TARGET", 103)
                    })
                    }
                );
    treeView.begin();
